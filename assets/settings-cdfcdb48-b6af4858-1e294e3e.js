...
`;class d extends g{constructor(){super("chat-component",{},_,r),this.initComponents(),d._style=r+o._style+m._style}initComponents(){const l=new o({placeholder:"Имя",type:"text",name:"first_name",regExp:t.name}).getContent(),n=new o({placeholder:"Фамилия",type:"text",name:"second_name",regExp:t.name}).getContent(),a=new o({placeholder:"Отображаемое имя",type:"text",name:"display_name",regExp:t.name}).getContent(),s=new o({placeholder:"Логин",type:"text",name:"login",regExp:t.login}).getContent(),p=new o({placeholder:"Почта",type:"email",name:"email",regExp:t.email}).getContent(),e=new o({placeholder:"Телефон",type:"phone",name:"phone",regExp:t.phone}).getContent(),c=new m({text:"Сохранить",events:{click:i=>this.onSubmit(i,"data")}}).getContent(),h=new o({placeholder:"Пароль",type:"password",name:"oldPassword",regExp:t.password}).getContent(),f=new o({placeholder:"Пароль",type:"password",name:"newPassword",regExp:t.password}).getContent(),u=new m({text:"Сохранить",events:{click:i=>this.onSubmit(i,"password")}}).getContent();this.components={saveDataButtonComponent:c,savePasswordButtonComponent:u,loginComponent:s,oldPasswordComponent:h,newPasswordComponent:f,emailComponent:p,firstNameComponent:l,lastNameComponent:n,phoneComponent:e,displayNameComponent:a}}onSubmit(l,n){var a;if(l.preventDefault(),this.components){const s={};(a=Object.values(this.components))==null||a.forEach(p=>{const e=p.querySelector("input");e&&(n==="password"&&e.type===n||n==="data"&&e.type!=="password")&&(e.focus(),e.blur(),s[e.name]=e.value)}),console.log(s)}}}export{d as SettingsComponent};
